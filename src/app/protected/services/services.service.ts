...
export class ServicesService {
  ...
  getServicesList() {
    return this.http.get(this.basicUrl + "/api/v1/services", { 'headers': this.headers })
  }

  addServices(services: any) {
    debugger
    return this.http.post(this.basicUrl + "/api/v1/service-create", services, { 'headers': this.headers2 })
  }
  deleteSer(Id: number) {
    return this.http.get(this.basicUrl + "/api/v1/services/delete/"+Id, { 'headers': this.headers })
  }
